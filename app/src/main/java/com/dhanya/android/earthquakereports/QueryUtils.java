...
public class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData( String requestUrl ) {
        ...
        List earthquakes = extractEarthquakeFeatureFromJson(jsonResponse);
    ...
    @Nullable
    private static List<Earthquake> extractEarthquakeFeatureFromJson( String earthquakeJSON ) {
